...
declare namespace AMap {
  ...
  export class LngLat {
    ...
    /**
     * 当前经纬度坐标值经度移动w, 纬度移动s, 得到新的坐标。经度向右移为正值, 纬度向上移为正值,
     * 单位为米。(自v1.2 新增)
     * */
  ...
  export interface MapOptions {
    /**
     * 地图视口, 用于控制影响地图静态显示的属性, 如: 地图中心点“center”推荐直接使用zoom、
     * center属性为地图指定级别和中心点(自v1.3 新增)
     * */
    view?: View2D

    /**
     * 地图图层数组, 数组可以是图层 中的一个或多个, 默认为普通二维地图。当叠加多个图层时,
     * 普通二维地图需通过实例化一个TileLayer类实现(自v1.3 新增)
     * */
    layers?: Array<any>

    /**
     * 地图显示的缩放级别, 若center与level未赋值, 地图初始化默认显示用户所在城市范围
     * 3D地图下, zoom值, 可以设置为浮点数。(在V1.3.0版本level参数调整为zoom,
     * 3D地图修改自V1.4.0开始生效)
     * */
    zoom?: number
    ...
    /**
     * 地图显示的缩放级别范围在PC上, 默认为[3, 18], 取值范围[3-18]；在移动设备上,
     * 默认为[3, 19], 取值范围[3-19]
     * */
    zooms?: Array<any>

    /**
     * 地图语言类型可选值: zh_cn: 中文简体, en: 英文, zh_en: 中英文对照默认为: zh_cn:
     * 中文简体注: 由于图面内容限制, 中文、英文 、中英文地图POI可能存在不一致的情况(自v1.3 新增)
     * */
    lang?: string
    ...
    /**
     * 当前地图中默认显示的图层。默认图层可以是TileLayer.Satellite等切片地图,
     * 也可以是通过TileLayer自定义的切片图层(自v1.3 废弃)
     * */
    // defaultLayer?: TileLayer;

    /**
     * 地图是否可旋转, 默认false。3D视图默认为true, 2D视图默认false。
     * (V1.3版本新增, 3D视图自V1.4.0开始支持)
     * */
    ...
    /**
     * 是否支持可以扩展最大缩放级别, 和zooms属性配合使用设置为true的时候,
    ...
    /**
     * 地图是否可通过键盘控制, 默认为true方向键控制地图平移, "+"和"-"可以控制地图的缩放,
    ...
    /**
     * 地图在移动终端上是否可通过多点触控缩放浏览地图, 默认为true。关闭手势缩放地图,
     * 请设置为false。
     * */
    touchZoom?: boolean

    /**
     * 可缺省, 当touchZoomCenter=1的时候, 手机端双指缩放的以地图中心为中心,
     * 否则默认以双指中间点为中心
     * */
    touchZoomCenter?: number

    /**
     * 设置地图的显示样式, 目前支持两种地图样式: 第一种: 自定义地图样式,
     * 如"amap: //styles/d6bf8c1d69cea9f5c696185ad4ac4c86"可前往地图自定义平台
     * 定制自己的个性地图样式；第二种: 官方样式模版, 如"amap: //styles/grey"。
     * 其他模版样式及自定义地图的使用说明见开发指南
     * */
    mapStyle?: string

    /**设置地图上显示的元素种类支持'bg'(地图背景)、'point'(POI点)、'road'(道路)、
     * 'building'(建筑物)
     * */
    features?: Array<any>
    ...
    /**
     * 楼块出现和消失的时候是否显示动画过程, 3D视图有效, PC端默认true,
     * 手机端默认false。(自V1.4.0开始支持)
     * */
    ...
    /**
     * 设置地图的预加载模式, 开启预加载的地图会在适当时刻提前加载周边和上一级的地图数据,
     * 优化使用体验。该参数默认值true。 (自v1.4.4开始支持)
     * */
    preloadMode?: boolean
  }
  ...
  export class Map {
     ...
     * opts地图初始化参数对象, 参数详情参看MapOptions列表。
     * */
    constructor(container: string | HTMLDivElement, opts: MapOptions)
    /**
     * 唤起高德地图客户端marker页其中Object里面包含有
     * { id: "B000A7BD6C", POIIDname: String, 必要参数location: LngLat|position属性 必须参数}
     * */
     ...
     * 默认取值范围为[3-19]3D地图会返回浮点数, 2D视图为整数。(3D地图自V1.4.0开始支持)
     * */
    getZoom(): number
    ...
    /**
     * 获取当前地图视图范围, 获取当前可视区域。3D地图下返回类型为ArrayBounds,
     * 2D地图下仍返回Bounds 。(3D自V1.4.0开始支持)
     * */
    getBounds(): Bounds
    ...
    /**
     * 获取当前地图状态信息, 包括是否可鼠标拖拽移动地图、地图是否可缩放、
     * 地图是否可旋转(rotateEnable)、是否可双击放大地图、
    ...
    /**
     * 获取指定位置的地图分辨率, 单位: 米/像素。 参数point有指定值时,
     * 返回指定点地图分辨率, point缺省时, 默认返回当前地图中心点位置的分辨率
     * */
     ...
     * 参数zoom可设范围: [3, 19]3D地图下, 可将zoom设置为浮点数。(3D自V1.4.0开始支持)
     * */
    ...
    /**
     * 设置地图图层数组, 数组为一个或多个图层。当叠加多个图层时, 普通二维地图需通过实例化一个
     * TileLayer类实现(自v1.3 新增)
     * */
     ...
     * 建议不要同时使用center/setCenter()和setCity(),
     * 如一起使用程序将以setCity()作为最后结果。
     * */
    ...
    /**
     * 设置当前地图显示状态, 包括是否可鼠标拖拽移动地图、地图是否可缩放、
     * 地图是否可旋转(rotateEnable)、是否可双击放大地图、
     * 是否可以通过键盘控制地图旋转(keyboardEnable)等
     * */
     ...
     * 或者自定义的光标样式, 如:
     * setCursor("url('http: //http://lbs.amap.com/webapi/static/Images//0.png'),
     * pointer")
     * */
    ...
    /**
     * 插件加载方法。参数name中指定需要加载的插件类型, 同时加载多个插件时,
     * 以字符串数组的形式添加。在Callback回调函数中进行地图插件的创建、
     * 插件事件的绑定等操作；插件为地图功能的扩展, 按需加载；插件写作方法.
     * */
    ...
    /**
     * 设置地图的显示样式, 目前支持两种地图样式: 第一种: 自定义地图样式,
     * 如"amap: //styles/d6bf8c1d69cea9f5c696185ad4ac4c86"
     * 可前往地图自定义平台定制自己的个性地图样式；第二种: 官方样式模版,
     * 如"amap: //styles/grey"。其他模版样式及自定义地图的使用说明见开发指南
     * */
  ...
  /**
   * 二维地图显示视口, 用于定义二维地图静态显示属性, 如地图缩放级别“zoom”、
   * 地图中心点“center”等。
   * */
  export class View2D {
  ...
  export interface MarkerOptions {
     ...
     * 默认以marker左上角位置为基准点, 对准所给定的position位置,
    ...
    /**
     * 点标记显示内容, 可以是HTML要素字符串或者HTML DOM对象。content有效时,
     * icon属性将被覆盖
     * */
    content?: string | any
    ...
    /**
     * 点标记的旋转角度, 广泛用于改变车辆行驶方向 注: angle属性是使用CSS3来实现的,
     * 支持IE9及以上版本
     * */
    angle?: number

    /**
     * 是否自动旋转。点标记在使用moveAlong动画时, 路径方向若有变化,
     * 点标记是否自动调整角度, 默认为false。广泛用于自动调节车辆行驶方向。
  ...
  export class Marker {
    ...
    /**
     * 唤起高德地图客户端标注页其中Object里面包含有{ name: String, name属性
     * 必要参数 position: LngLat 坐标点 }
     * */
     ...
     * 若为String(图片url), 表示点标记以指定图片形式显示；若为Icon,
     * 表示点标记以Icon对象形式显示
     * */
    ...
    /**
     * 以指定的速度, 点标记沿指定的路径移动。参数path为路径坐标串；
     * speed为指定速度, 单位: 千米/小时； 回调函数f为变化曲线函数,
     * 缺省为function(k){return k}；参数circlable表明是否循环执行动画, 默认为false
     * */
    moveAlong(path: Array<any>, speed: number, f: Function, circlable: boolean): void

    /**
     * 以给定速度移动点标记到指定位置。参数lnglat为指定位置, 必设；speed为指定速度,
     * 单位: 千米/小时；回调函数f为变化曲线函数, 缺省为function(k){return k}。
     * */
  ...
  export interface MarkerShapeOptions {
    /**
     * 可点击区域组成元素数组, 存放图形的像素坐标等信息,
     * 该数组元素由type决定: - circle: coords格式为 [x1, y1, r], x1, y1为圆心像素坐标,
     * r为圆半径 - poly: coords格式为 [x1, y1, x2, y2 … xn, yn],
     * 各x, y表示多边形边界像素坐标 - rect: coords格式为 [x1, y1, x2, y2],
     * x1, y1为矩形左上角像素坐标, x2, y2为矩形右下角像素坐标
  ...
  export interface IconOptions {
    ...
    /**
     * 图标取图偏移量。当image中指定了一个大图时,
     * 可通过size和imageOffset配合, 显示图标的指定范围
     * */
    imageOffset?: Pixel
  ...
  export interface ElasticMarkerOptions {
    ...
    /**
     * 点标记的叠加顺序。地图上存在多个点标记叠加时,
     * 通过该属性使级别较高的点标记在上层显示 默认zIndex: 100
     * */
    zIndex?: number
  ...
  export class ElasticMarker {
    ...
    /**
     * 地图上有多个marker时, 当isTop为true时, marker将显示在最前面；当为false时,
     * marker取消置顶*/
    setTop(isTop: boolean): void
  ...
  export interface TextOptions {
    ...
    /**
     * 是否自动旋转。点标记在使用moveAlong动画时, 路径方向若有变化, 点标记是否自动调整角度,
     * 默认为false。广泛用于自动调节车辆行驶方向。 IE8以下不支持旋转, autoRotation属性无效
     * */
    autoRotation?: boolean
  ...
  export interface PolylineOptions {
     ...
     * 此属性在ie9+浏览器有效 取值: 实线: [0, 0, 0] 虚线: [10, 10] , [10, 10]
     * 表示10个像素的实线和10个像素的空白(如此反复)组成的虚线
     * 点画线: [10, 2, 10], [10, 2, 10] 表示10个像素的实线和2个像素的空白 + 10个像素的实线
     * 和10个像素的空白 (如此反复)组成的虚线
     * */
    ...
    /**
     * 是否延路径显示白色方向箭头, 默认false。Canvas绘制时有效,
     * 建议折线宽度大于6时使用；在3D视图下不支持显示方向箭头(自V1.4.0版本参数效果变更)
     * */
    showDir?: boolean
  }
  ...
  export interface PolygonOptions {
    ...
    /**
     * 折线覆盖物的叠加顺序。默认叠加顺序, 先添加的线在底层, 后添加的线在上层。通过该属性
     * 可调整叠加顺序, 使级别较高的折线覆盖物在上层显示 默认zIndex: 50
     * */
    zIndex?: number
     ...
     * 勾勒形状轮廓的虚线和间隙的样式, 此属性在strokeStyle 为dashed 时有效,
     * 此属性在ie9+浏览器有效 取值: 实线: [0, 0, 0] 虚线: [10, 10] , [10, 10]
     * 表示10个像素的实线和10个像素的空白(如此反复)组成的虚线 点画线: [
     * 10, 2, 10], [10, 2, 10] 表示10个像素的实线和2个像素的空白 + 10个像素的实线和
     * 10个像素的空白 (如此反复)组成的虚线
     * */
    strokeDasharray?: Array<any>
  ...
  export class MouseTool {
    ...
    /**
     * 开启鼠标画折线模式。鼠标在地图上点击绘制折线，鼠标左键双击或右键单击结束绘制，
     * 折线样式参考PolylineOptions设置
     * */
    polyline(options: PolylineOptions): void
    /**
     * 开启鼠标画多边形模式。鼠标在地图上单击开始绘制多边形，鼠标左键双击或右键单击结束当前
     * 多边形的绘制，多边形样式参考PolygonOptions设置
     * */
     ...
     * */
    circle(options: PolygonOptions): void
    /**
  ...
  export interface DistrictLayerProvinceOptions {
    /** 图层叠加的顺序值，0表示最底层。 */
    zIndex: Number
    /** 行政区的adcode */
    adcode: Array<any>
    /**
     * depth字段设定数据的层级深度，depth为0的时候只显示省面，
     * depth为1的时候显示市级，当depth为2的可以显示县一级。
     * */
    depth: Number
    styles: any
  }
  ...
  export namespace DistrictLayer {
    /**
     * 单独展示一个或者组合展示多个中国行政区的区域，支持展示省级、市级、县级。
     * 可配置各省、市、县的边界颜色和面填充色
     * */
    export class Province {
      constructor(options: DistrictLayerProvinceOptions)
    }
  }
}
